...
internal object KetchPalette {
  ...
  object Light {
    ...
    val panel = Color(0xFFF0F3F9)
    val line = Color(0xFFD8DFEA)
    val lineSoft = Color(0xFFE6EAF2)
    val text = Color(0xFF182238)
    val textSec = Color(0xFF58667C)
    val textDim = Color(0xFF69768B)
    val success = Color(0xFF237B43)
    val warning = Color(0xFF996300)
    val danger = Color(0xFFC73349)
  }

  data class AccentTriple(val primary: Color, val container: Color, val onContainer: Color)

  val SignalLight = AccentTriple(Color(0xFF4F5DE4), Color(0xFFE9ECFF), Color(0xFF3C47B7))

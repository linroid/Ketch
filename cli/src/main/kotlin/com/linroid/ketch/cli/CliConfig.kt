...
fun loadConfig(path: String): KetchConfig {
  val file = File(path)
  if (!file.exists()) {
    throw IllegalArgumentException("Config file not found: $path")
  }
  return Toml.decodeFromString(KetchConfig.serializer(), file.readText())
}
...
private const val DEFAULT_CONFIG_CONTENT = """# Ketch Server Configuration

 ...
 * path/ownership indexes, the recheck chunk, and checkpoint decoding. Piece buffers, peer bitfields
 * and wire buffers are charged by TorrentSwarm against the transfer budget, so the piece length
 * never counts here. This is admission accounting, not measured heap/RSS.
